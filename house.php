...
<form style="margin-top: 10px; margin-bottom: 10px; margin-left:70px; margin-right:70px;" action="house.php" method= "POST">
  <br>
<?php
...
$image= base64_encode($image);
 ...
 $stmt="insert into buyhouse(HID,CID, SID,IMAGE)
	values('$hid','$cid','$sid',$image)";
