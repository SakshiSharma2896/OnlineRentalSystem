...
<nav style="background-color: #34A375;color: white;" class="navbar navbar-default">
 ...
 <li><a style="font-size: 15px;margin-left: 100px;margin-right: 30px;color: white;" href=food.php">Food</a></li>
...
<form style="margin-top: 10px; margin-left:170px; margin-right:70px; margin-bottom:20px;" action='luggage.php' method=POST><font align="center">
  <br>
<?php
...
$image= base64_encode($image);
 $stmt="insert into buyluggage(LID,CID, SID,IMAGE)
	values('$lid','$cid','$sid',$image)";
$run=mysqli_query($conn,$stmt);
if($run)
{
echo '<script type= "text/javascript"> alert("Luggage booked successfully!") </script>';	
