...
<form style="margin-top: 10px; margin-left:70px; margin-right:70px; margin-bottom:20px;" action='vehicle.php' method=POST><font align="center">
  <br>
<?php
...
$image= base64_encode($image);
 $stmt="insert into buyvehicle(VID,CID, SID,IMAGE)
	values('$vid','$cid','$sid',$image)";
$run=mysqli_query($conn,$stmt);
if($run)
{
echo '<script type= "text/javascript"> alert("Vehicle booked successfully!") </script>';	
